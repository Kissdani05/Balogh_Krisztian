...
const FOOTER_SOCIALS = [
  { label: "Facebook", href: "https://www.facebook.com/balogh.krisztian.9256" },
  { label: "WhatsApp", href: "https://wa.me/36309401184" }
];
...
function SocialIcon({ name }: { name: string }) {
  switch (name) {
    ...
    case 'WhatsApp':
      return (
        <svg viewBox="0 0 24 24" width={22} height={22} aria-hidden>
          <path d="M12 3.5a8.5 8.5 0 0 0-7.2 13L4 21l4.6-1.2A8.5 8.5 0 1 0 12 3.5Z" stroke="currentColor" strokeWidth="1.2" fill="none" strokeLinejoin="round" />
          <path d="M10.1 8.7c-.2-.4-.5-.4-.7-.4h-.6c-.3 0-.6.1-.8.4-.2.3-.7.8-.7 1.9 0 1.1.8 2.1.9 2.3.1.1 1.6 2.5 3.8 3.6.5.2.9.4 1.3.5.5.2 1 .1 1.4 0 .4-.1 1.2-.5 1.4-1 .2-.5.2-.9.1-1-.1-.1-.2-.2-.5-.3l-1.2-.5c-.2-.1-.4 0-.5.1l-.5.5c-.1.1-.2.2-.4.1-.5-.2-1-.5-1.5-.9-.5-.4-.9-.9-1.2-1.4-.1-.2 0-.3.1-.4l.4-.5c.1-.2.2-.3.1-.5l-.5-1.1z" fill="currentColor" />
        </svg>
      );
    default:
      return null;
        ...
        <div className="container footer-inner">
          ...
          <div className="footer-socials">
            {FOOTER_SOCIALS.map((social) => (
              <a key={social.label} href={social.href} className="fsoc" aria-label={social.label}>
